...
set CLASSPATH=%APP_HOME%\lib\Test1.jar;%APP_HOME%\lib\slf4j-api-1.7.13.jar;%APP_HOME%\lib\guava-20.0.jar

@rem Execute Test1
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %TEST1_OPTS%  -classpath "%CLASSPATH%" com.hkm.myTest.MainApp %CMD_LINE_ARGS%
